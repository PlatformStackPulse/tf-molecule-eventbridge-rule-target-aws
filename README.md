...
[![Terraform Format](https://img.shields.io/badge/terraform-fmt-blue?logo=terraform)](https://github.com/PlatformStackPulse/tf-molecule-eventbridge-rule-target-aws/actions)
[![Terraform Validate](https://img.shields.io/badge/terraform-validate-blue?logo=terraform)](https://github.com/PlatformStackPulse/tf-molecule-eventbridge-rule-target-aws/actions)
[![TFLint](https://img.shields.io/badge/tflint-passing-brightgreen?logo=terraform)](https://github.com/PlatformStackPulse/tf-molecule-eventbridge-rule-target-aws/actions)
[![Terraform Test](https://img.shields.io/badge/tests-2%20passed-brightgreen?logo=terraform)](https://github.com/PlatformStackPulse/tf-molecule-eventbridge-rule-target-aws/actions)
[![Security Scan](https://img.shields.io/badge/trivy-passing-brightgreen?logo=aqua)](https://github.com/PlatformStackPulse/tf-molecule-eventbridge-rule-target-aws/actions)
...
[![Documentation](https://img.shields.io/badge/docs-terraform--docs-blue?logo=readthedocs)](https://github.com/PlatformStackPulse/tf-molecule-eventbridge-rule-target-aws/actions)
...
```hcl
module "event_rule" {
  source = "git::https://github.com/PlatformStackPulse/tf-molecule-eventbridge-rule-target-aws.git?ref=v1.0.0"
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_rule"></a> [rule](#module\_rule) | git::https://github.com/PlatformStackPulse/tf-atom-eventbridge-rule-aws.git | 5e7a4a3c9bbce659af1cda9b5f8251efb5bf0520 |
| <a name="module_target"></a> [target](#module\_target) | git::https://github.com/PlatformStackPulse/tf-atom-eventbridge-target-aws.git | f09bcda9b1efd814b65e5737f89c7510bf00bd4a |
...
| <a name="input_dead_letter_arn"></a> [dead\_letter\_arn](#input\_dead\_letter\_arn) | ARN of the SQS queue for dead letters | `string` | `null` | no |
| <a name="input_delimiter"></a> [delimiter](#input\_delimiter) | Delimiter to be used between ID elements.<br/>Defaults to `-` (hyphen). Set to `""` to use no delimiter at all. | `string` | `null` | no |
| <a name="input_description"></a> [description](#input\_description) | Description of the EventBridge rule | `string` | `null` | no |
...
| <a name="input_event_pattern"></a> [event\_pattern](#input\_event\_pattern) | Event pattern JSON | `string` | `null` | no |
...
| <a name="input_input_path"></a> [input\_path](#input\_input\_path) | JSONPath to extract from the event | `string` | `null` | no |
...
| <a name="input_maximum_event_age_in_seconds"></a> [maximum\_event\_age\_in\_seconds](#input\_maximum\_event\_age\_in\_seconds) | Maximum age of event in seconds | `number` | `null` | no |
| <a name="input_maximum_retry_attempts"></a> [maximum\_retry\_attempts](#input\_maximum\_retry\_attempts) | Maximum retry attempts | `number` | `null` | no |
...
| <a name="input_role_arn"></a> [role\_arn](#input\_role\_arn) | IAM role ARN for EventBridge to assume | `string` | `null` | no |
| <a name="input_rule_state"></a> [rule\_state](#input\_rule\_state) | State of the rule (ENABLED or DISABLED) | `string` | `"ENABLED"` | no |
| <a name="input_schedule_expression"></a> [schedule\_expression](#input\_schedule\_expression) | Schedule expression (e.g., rate(1 hour)) | `string` | `null` | no |
